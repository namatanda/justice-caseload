-- CreateEnum
CREATE TYPE "public"."CourtType" AS ENUM ('SC', 'ELC', 'ELRC', 'KC', 'SCC', 'COA', 'MC', 'HC', 'TC');
...
CREATE TABLE "public"."courts" (
    ...
    "court_type" "public"."CourtType" NOT NULL,
...
CREATE TABLE "public"."cases" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "caseid_type" VARCHAR(20),
    "caseid_no" VARCHAR(50),
...
CREATE TABLE "public"."case_activities" (
    ...
    "judge_6" VARCHAR(255),
    "judge_7" VARCHAR(255),
    "coming_for" VARCHAR(100),
    "legal_rep_string" VARCHAR(10),
...
-- CreateIndex
CREATE INDEX "cases_male_applicant_idx" ON "public"."cases"("male_applicant");

-- CreateIndex
CREATE INDEX "cases_female_applicant_idx" ON "public"."cases"("female_applicant");

-- CreateIndex
CREATE INDEX "cases_male_defendant_idx" ON "public"."cases"("male_defendant");

-- CreateIndex
CREATE INDEX "cases_female_defendant_idx" ON "public"."cases"("female_defendant");

-- CreateIndex
CREATE INDEX "cases_organization_applicant_idx" ON "public"."cases"("organization_applicant");

-- CreateIndex
CREATE INDEX "cases_organization_defendant_idx" ON "public"."cases"("organization_defendant");

-- CreateIndex
CREATE UNIQUE INDEX "cases_case_number_court_name_key" ON "public"."cases"("case_number", "court_name");
...
-- CreateIndex
CREATE INDEX "case_activities_coming_for_idx" ON "public"."case_activities"("coming_for");

-- CreateIndex
CREATE INDEX "case_activities_legal_rep_string_idx" ON "public"."case_activities"("legal_rep_string");

-- CreateIndex
CREATE INDEX "case_activities_custody_numeric_idx" ON "public"."case_activities"("custody_numeric");

-- CreateIndex
CREATE INDEX "case_activities_judge2_idx" ON "public"."case_activities"("judge_2");

-- CreateIndex
CREATE INDEX "case_activities_judge3_idx" ON "public"."case_activities"("judge_3");

-- CreateIndex
CREATE INDEX "case_activities_judge4_idx" ON "public"."case_activities"("judge_4");

-- CreateIndex
CREATE INDEX "case_activities_judge5_idx" ON "public"."case_activities"("judge_5");

-- CreateIndex
CREATE INDEX "case_activities_judge6_idx" ON "public"."case_activities"("judge_6");

-- CreateIndex
CREATE INDEX "case_activities_judge7_idx" ON "public"."case_activities"("judge_7");
